<#
.SYNOPSIS
    Prueba de insercion individual (SIN batch) para el nivel p06 (OMP_NUM_THREADS=6).
...
& "$PSScriptRoot\_single_insert_runner.ps1" -BaseUrl $BaseUrl -Requests $Requests -Level "p06" -Run $Run -OutCsv $OutCsv

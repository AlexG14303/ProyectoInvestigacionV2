<#
.SYNOPSIS
    Prueba de inserción individual (SIN batch) para el nivel p01 (OMP_NUM_THREADS=1).
...
& "$PSScriptRoot\_single_insert_runner.ps1" -BaseUrl $BaseUrl -Requests $Requests -Level "p01" -Run $Run -OutCsv $OutCsv
